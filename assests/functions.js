...
function showPosition(position) {
    ...
    if (position.coords.latitude) {
        ...
        showAddressButton.innerHTML = "<a href='" + address + "' class='waves-effect waves-light bGreen cBlack btn-small btn-block' target='_blank'><i class='fa fa-map-marker' aria-hidden='true' ></i> Open Maps</a>";
    } else {
